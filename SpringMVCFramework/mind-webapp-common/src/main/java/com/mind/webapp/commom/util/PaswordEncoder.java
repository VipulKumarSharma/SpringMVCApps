package com.mind.webapp.commom.util;
...
public class PaswordEncoder implements PasswordEncoder {
	...
	public boolean isPasswordValid(String encodedPwd, String rawPwd, Object salt) {
		...
		// Added condition as password policy changed
		else if (encodedPwd.equals(this.encodePassword(rawPwd.toLowerCase(),
				salt))) {
			return true;
